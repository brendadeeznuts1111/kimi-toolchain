...
| Cross-ref by intent (`@see`)      | [docs/references/namespace.md](docs/references/namespace.md#practical-see-ladder) § Practical `@see` ladder          | Lowest rung first — `@see dx` vs namespace vs reference docs vs schemas; runtime mirrors in `kimi-toolchain`, `finish-work`, `orchestrator`, `herdr` skills (`~/.kimi-code/docs/references/namespace.md#practical-see-ladder`) |
