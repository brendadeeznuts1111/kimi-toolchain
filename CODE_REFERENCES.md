...
| Cross-ref by intent (`@see`)      | [docs/references/namespace.md](docs/references/namespace.md) § Practical `@see` ladder                               | Lowest rung first — `@see dx` vs namespace vs reference docs vs schemas                                                          |
