...
const UNIT_STEM_SOURCE: Record<string, string> = {
  ...
  "sync-archive": "src/harness/sync.ts",
  "archive-baseline-integration": "src/lib/restore-baseline.ts",
  ...
  "bun-utils-hex": "src/lib/bun-utils.ts",
  "bun-utils-runtime": "src/lib/bun-utils.ts",
  "bun-utils-sleep": "src/lib/bun-utils.ts",
