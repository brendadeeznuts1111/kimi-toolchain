...
const UNIT_STEM_SOURCE: Record<string, string> = {
  ...
  "handoff-probes": "src/lib/discover-dx-inventory.ts",
  "context-sync-from-report": "src/lib/finish-work-herdr.ts",
  "deletion-metric": "scripts/check-deletion-metric.ts",
  "workspace-runtime": "src/lib/workspace-runtime.ts",
  "runtime-introspection": "src/lib/runtime-introspection.ts",
  "open-check-source": "src/lib/health-check.ts",
