...
const HERDR_TARGETS: Record<string, string> = {
  "herdr-dashboard/server/server.ts": "server/server.ts",
  "herdr-dashboard/server/http3.ts": "server/http3.ts",
  "herdr-dashboard/server/hub.ts": "server/hub.ts",
  "herdr-dashboard/server/events.ts": "server/events.ts",
  "herdr-dashboard/server/bridge.ts": "server/bridge.ts",
  "herdr-dashboard/data/data.ts": "data/data.ts",
  "herdr-dashboard/discovery/cache.ts": "discovery/cache.ts",
  "herdr-dashboard/discovery/meta.ts": "discovery/meta.ts",
  "herdr-dashboard/widgets/widgets.ts": "widgets/widgets.ts",
  "herdr-dashboard/widgets/git.ts": "widgets/git.ts",
  "herdr-dashboard/widgets/logs.ts": "widgets/logs.ts",
  "herdr-dashboard/widgets/processes.ts": "widgets/processes.ts",
  "herdr-dashboard/widgets/processes-action.ts": "widgets/processes-action.ts",
  "herdr-dashboard/widgets/session.ts": "widgets/session.ts",
  "herdr-dashboard/automation/automation.ts": "automation/automation.ts",
  "herdr-dashboard/automation/automation-gate.ts": "automation/automation-gate.ts",
  "herdr-dashboard/gates/gate-watch.ts": "gates/gate-watch.ts",
  "herdr-dashboard/gates/meta-gate.ts": "gates/meta-gate.ts",
