...
| Namespace / `@see` routing | Toolchain reference docs                         | `@see namespace-boundaries` → [namespace.md § Name collision resolver](~/.kimi-code/docs/references/namespace.md#name-collision-resolver) |
