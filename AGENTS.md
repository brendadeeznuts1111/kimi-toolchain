...
| `bunfig.toml`                          | Bun install + `[define]` build-time constants (SSOT for toolchain tuning) |
| `types/build-constants.d.ts`           | TypeScript globals for `bunfig.toml` `[define]`                           |
| `scripts/lint-build-constants.ts`      | Regression lint — forbids tuning literals outside `[define]`              |
