...
|---------|------|---------------|
| Platform absorption | `skills/kimi-toolchain/examples/platform-absorption.md` | How Bun substrate improvements tighten thresholds automatically |
| Image effect | `skills/kimi-toolchain/examples/image-effect.md` | First concrete domain effect — full scan → benchmark → train → report loop |
