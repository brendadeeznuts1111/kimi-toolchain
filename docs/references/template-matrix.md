...
| **scaffold**        | 23    | `kimi-fix <path>`                    | Project root (`./`)                                                                                                                                                      | Non-destructive (`!pathExists`)                       | **High** with `bun init` — mitigated by `-m` |
...
| `templates/scaffold/`       | Project root (on `kimi-fix`)    | `kimi-fix <path>` | 23 files per project                                              |
