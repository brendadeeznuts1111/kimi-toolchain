...
/** Canonical machine ~/.bunfig.toml SSOT for isolated install-policy tests. */
export function seedMachineBunfigSsot(home: string, cacheDir?: string): void {
  const dir = cacheDir ?? join(home, ".bun-cache");
  writeText(
