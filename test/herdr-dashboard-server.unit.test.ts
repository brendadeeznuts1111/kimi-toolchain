...
describe("herdr-dashboard-server", () => {
  ...
  test("dashboard server processes widget returns 200 with session context", async () => {
    const server = startHerdrDashboardServer({
      projectPath: REPO_ROOT,
      port: 0,
      sessions: false,
  ...
  test("dashboard server logs widget returns 200 with pane scrollback", async () => {
    const server = startHerdrDashboardServer({
      projectPath: REPO_ROOT,
      port: 0,
      sessions: false,
  ...
  test("dashboard server logs widget returns 200 when paneId missing", async () => {
    const server = startHerdrDashboardServer({
      projectPath: REPO_ROOT,
      port: 0,
      sessions: false,
  ...
  test("dashboard server processes action POST runs pane focus", async () => {
    let actionCalls = 0;
    const server = startHerdrDashboardServer({
      projectPath: REPO_ROOT,
      port: 0,
  ...
  test("dashboard server processes action POST validates body", async () => {
    const server = startHerdrDashboardServer({
      projectPath: REPO_ROOT,
      port: 0,
      sessions: false,
  ...
  test("dashboard server git widget returns 200 with session context", async () => {
    const server = startHerdrDashboardServer({
      projectPath: REPO_ROOT,
      port: 0,
      sessions: false,
  ...
  test("dashboard server unknown widget returns 404", async () => {
    const server = startHerdrDashboardServer({
      projectPath: REPO_ROOT,
      port: 0,
      sessions: false,
