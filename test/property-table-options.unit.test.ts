...
import { buildPropertyTable, PROPERTY_TABLE_COLUMNS } from "../src/lib/property-table.ts";
...
describe("property-table-options", () => {
  ...
  test("applyTableRenderOptions --exact on TypeScript Property/Type rows", async () => {
