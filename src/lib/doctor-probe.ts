  ...
  return {
    ...
    flags: [
      ...
      },
      {
        name: "--run-gates",
        type: "boolean",
        description: "Run all built-in gates in topological order",
        agentFacing: true,
      },
      {
        name: "--dryrun",
      ...
      },
      {
        ...
        type: "boolean",
        description:
          "Persist gate result JSON under .kimi/artifacts/{gate}/ (full closure when used with --gate or --run-gates)",
        agentFacing: true,
      },
      {
        name: "--artifacts-list",
